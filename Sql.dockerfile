...
RUN sqlcmd -d Telligent -Q 'INSERT INTO [dbo].[te_PluginConfiguration] (Type, Configuration) VALUES (''Telligent.Evolution.CoreServices.Sockets.MessageBusServiceConnector.MessageBusServiceConnectorPlugin, Telligent.Evolution.Core'', ''host=172.18.209.3&port=9623'')'